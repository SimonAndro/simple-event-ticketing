...
<head>
    ...
    <title>Activity Ticketing</title>

    <link rel="stylesheet" href="./assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="./assets/css/animation-bg.css">
    <link rel="stylesheet" href="./assets/css/base.css">
</head>

<body style="overflow-x: hidden; overflow-y: scroll;">
    <canvas id="sakura" style="position: absolute; z-index: -1;">
    </canvas>
    <!-- main content -->
    <div>
            ...
            <div class="row justify-content-md-center">
                <div class="col-md-6">
                    <div class="text-center">
                        <img class="" src="./assets/img/cl.png" alt="country league logo">
                    </div>
                    <div class="">
                        <h1 class="text-center text-light" style="text-shadow: 2px 2px #dd726a;"> Get Together Party
                        </h1>
                    </div>
                    ...
                    <form class="mt-3" method="post" action="" id="general-form" onsubmit="return false">
                        ...
                        <div class="form-group">
                            <label for="student-num" class="text-light"
                                style="font-size: 25px; text-shadow: 2px 2px #2196f378;">Enter Student No.</label>
                            <input name="studnum" type="text" class="form-control" id="student-num"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center">                 
                    <a id="studnum-placeholder" href="./index.html" class="btn  btn-primary" target="_blank" download>Download Ticket</a>                               
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="./assets/js/animation-bg.js"></script>
